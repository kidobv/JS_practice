...
//Pagination Question -
/**
 * The output of this function shold be something like this <2, 3, 4, 5* 6, 7, 8> where 5 is the current page, total = 10, and show = 7 
 * Note we want to have the current page as centered as possible
 * @param {*} total - represent the total num of pages
 * @param {*} show - the number of page number to display in the pagination selector
